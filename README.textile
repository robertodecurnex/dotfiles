...
In order to allow the creation of config files wihtin child directories, without deleting the parent one, _*_*_ can be used as prefix fo the dirnames (see "examples":/#examples). 
